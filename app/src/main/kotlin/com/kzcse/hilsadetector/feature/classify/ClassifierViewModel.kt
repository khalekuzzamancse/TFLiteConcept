package com.kzcse.hilsadetector.feature.classify

import android.content.Context
import android.graphics.Bitmap
import androidx.lifecycle.ViewModel
import com.kzcse.hilsadetector.core.language.Logger
import com.kzcse.hilsadetector.core.ml.ClassifierFactory
import com.kzcse.hilsadetector.core.platfrom.BitmapUtils
import com.kzcse.hilsadetector.feature._core.logic.Constants
import com.kzcse.hilsadetector.feature._core.logic.CustomException
import com.kzcse.hilsadetector.feature._core.presentation.GlobalMessenger
...
class ClassifierViewModel(context: Context) : ViewModel() {
   ...
   suspend fun classify(bitmap: Bitmap) {
        try {
            ...
            Logger.on("ClassifyViewModel","output","$e")
            setResult(null)
