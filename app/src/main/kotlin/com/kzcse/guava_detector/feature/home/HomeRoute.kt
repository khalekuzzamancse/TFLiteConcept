package com.kzcse.guava_detector.feature.home
...
private fun HomeTitle() {
    Text(
        text = "Welcome to Guava Detector",
        fontSize = 28.sp,
...
private fun HomeIntroduction() {
    Text(
        text = "Detect Guava with ease! Our AI model identifies five different Guava classes accurately.",
        fontSize = 16.sp,
        textAlign = TextAlign.Center,
