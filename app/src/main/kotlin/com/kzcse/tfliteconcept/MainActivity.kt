...
import com.kzcse.tfliteconcept.feature.navigation.NavigationRootX
        ...
        setContent {
            ...
            AppTheme {
                Scaffold(
                    ...
                    Box(Modifier.padding(innerPadding).widthIn(max = 650.dp), contentAlignment = Alignment.TopCenter)
                    {
                        NavigationRootX()
